      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-sm bg-background border border-border p-8">
          ...
          >
            ...
            {githubLoading ? '跳转中...' : '使用 GitHub 账号注册'}
          </button>

          {/* 分隔线 */}
          <div className="flex items-center gap-4 mb-6">
            <div className="flex-1 h-px bg-border" />
            <span className="text-xs font-mono text-muted-foreground uppercase">或邮箱注册</span>
            <div className="flex-1 h-px bg-border" />
          </div>
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            已有账号？{' '}
            <Link href="/login" className="text-foreground underline hover:text-brand">
              登录
            </Link>
          </p>
        </div>
